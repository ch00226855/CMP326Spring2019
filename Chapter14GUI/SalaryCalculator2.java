...
public class SalaryCalculator2 extends JFrame implements ActionListener, ChangeListener{
	...
	public SalaryCalculator2() {
		...
		tableVals[0][0] = 100;
		tableVals[0][1] = "Monday";
		String[] headers = {"Col1", "Col2", "Col3", "Col4"};
		
		tempTable = new JTable(tableVals, headers);
...
//		constraints.gridy = 7;
//		constraints.insets = new Insets(10, 10, 10, 10);
//		add(tempTable.getTableHeader(), constraints);
//		
//		constraints = new GridBagConstraints();
//		constraints.gridx = 0;
//		constraints.gridy = 8;
//		constraints.insets = new Insets(10, 10, 10, 10);
//		add(tempTable, constraints);
//		
//		tempTable.setValueAt("Adam", 4, 1);
	}
